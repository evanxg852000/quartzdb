...
impl GrpcMetastoreService for GrpcServerMetastoreServiceImpl {
    async fn fetch_events(
        ...
        let events = self.inner.fetch_events(last_checkin)
            .await
            .map_err(|e| Status::internal(e.to_string()))?;
        let events = bitcode::serialize(&events)
            .map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn list_tables(
        ...
        let tables = self.inner.list_tables()
            .await
            .map_err(|e| Status::internal(e.to_string()))?;
        let tables = bitcode::serialize(&tables)
            .map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn put_table(
        ...
        let table_meta = bitcode::deserialize(&table)
            .map_err(|e| Status::internal(e.to_string()))?;
        self.inner.put_table(table_meta)
            .await
            .map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn get_table(
        ...
        let table_meta = self.inner.get_table(&table_name)
            .await
            .map_err(|e| Status::internal(e.to_string()))?;
    ...
    async fn delete_table(
        ...
        let table_name = request.into_inner().name;
        self.inner.delete_table(&table_name)
            .await
            .map_err(|e| Status::internal(e.to_string()))?;
